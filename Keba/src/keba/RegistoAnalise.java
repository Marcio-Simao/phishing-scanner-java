...
public class RegistoAnalise {
    ...
    public String getFicheiroAnalisado() {
        return ficheiroAnalisado;
    }
    ...
    public int getEmailsSuspeitos() {
        return emailsSuspeitos;
    }

    public int getEmailsSeguros() {
        return emailsSeguros;
    }
    ...
    public void setFicheiroAnalisado(String f) {
        this.ficheiroAnalisado = f;
    }

    public void setTotalEmails(int t) {
        this.totalEmails = t;
    }

    public void setEmailsSuspeitos(int e) {
        this.emailsSuspeitos = e;
    }

    public void setEmailsSeguros(int e) {
        this.emailsSeguros = e;
    }
